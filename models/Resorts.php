...
class Resorts{
	...
	public function updateResorts($post_data, $image_file){
		...
		if($image !== "failed"){
			...
			return $array=array($this->getResorts("All"), $status);
	...
	public function addResorts($post_data, $image_file){
	...
	public function deleteResorts($id){
